...
//                            border: Border(top: BorderSide(color: Color(0xfff5f5f5),width: 0),bottom: BorderSide(color: Color(0xfff5f5f5),width: 1))
                        ...
                        child: ListTileWidget(iconpic: Icons.room,titletxt: '收货地址',subtitle: ''),   //
                      ),//
                      ListTileWidget(iconpic: Icons.share,titletxt: '分享',subtitle: '邀请好友赢大礼'),   //
                      ListTileWidget(iconpic: Icons.smartphone,titletxt: '绑定手机',subtitle: '绑定手机'),//
                      ListTileWidget(iconpic: Icons.phone,titletxt: '联系客服',subtitle: '联系客服'),   //
                    ],
                ),
              ),
            ],
